...
import LienHeSection from './LienHeSection'
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ===================================================================
            SECTION 4: LIÊN HỆ THỰC TIỄN (Figma Component 15 / Node 298:2221)
            Pixel-Perfect Translation of 4 Variants:
            - lien-he-01-gioi-thieu (298:2175)
            - lien-he-02-bang-so-sanh (298:2176)
            - lien-he-03-bai-hoc (298:2177)
            - Variant 4 (298:2345)
           =================================================================== */}
        <LienHeSection
          onNavigateToThinker={(thinker) => {
            setActiveThinker(thinker)
            scrollToTop()
          }}
